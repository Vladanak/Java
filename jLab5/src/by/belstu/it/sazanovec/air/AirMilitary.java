...
public class AirMilitary implements Air {
    ...
    public AirMilitary() {}
    public AirMilitary(AirType airType) {
        this.airType = airType;
    }
    public AirMilitary(AirType airType, int countPassengers) {
        this.airType = airType;
    ...
    @Override
    public String fly() {
        return "Военный самолёт взлетел";
    }
